"""Asynchronous A3C training worker."""
...
def train(rank, args, shared_model, optimizer, train_modes, n_iters, env=None):
    """Run one A3C worker: collect rollouts and push gradients to the shared model."""
    n_iter = 0
    ...
    if env is None:
        env = make_env(env_name, args, rank)
    ...
    while True:
        ...
        fps = s_i / elapsed_time if elapsed_time > 0 else 0
